...
function get_api_data(){
  ...
  echo'<div class="col-md-4">';
  echo '<table class="table">';
  echo '<thead class="thead-dark"><tr><th>Flop 5</td><th>Cloture</th><th>Variation</th></tr></thead>';
  foreach ($data_slice_gca as $item) {
      echo '<tr>';
      echo '<td>'.$item->Code_symbole.'</td>';
      echo '<td>'.number_format((float)$item->Cours_Cloture, 2, '.', '').'</td>';
  ...
  echo'<div class="col-md-4">';
  echo '<table class="table">';
  echo '<thead class="thead-dark"><tr><th>Activites du marche</td><th>Cloture</th><th>Variation</th></tr></thead>';
  foreach ($data_slice_gca as $item) {
      echo '<tr>';
      echo '<td>'.$item->Code_symbole.'</td>';
      echo '<td>'.number_format((float)$item->Cours_Cloture, 2, '.', '').'</td>';
